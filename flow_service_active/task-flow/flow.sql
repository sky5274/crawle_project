...
CREATE TABLE `flow_group`  (
  ...
  `create_code` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '流程控制--分组' ROW_FORMAT = Dynamic;
...
CREATE TABLE `flow_main`  (
  ...
  `start_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '流程起始id',
  `group_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '分组id',
  `status` int(0) NULL DEFAULT 0 COMMENT '流程状态：0，正常；-1作废',
  `create_code` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人编码',
  `create_name` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `version` int(0) NULL DEFAULT NULL,
  `ts` timestamp(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '流程控制--主体' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of flow_main
-- ----------------------------
INSERT INTO `flow_main` VALUES ('1012432328', '测试', NULL, '1234', 0, NULL, NULL, 1, '2019-06-30 12:03:42');
INSERT INTO `flow_main` VALUES ('98206404485054464', 'demo', NULL, '1234', 0, NULL, NULL, 6, '2021-02-13 09:08:52');
...
CREATE TABLE `flow_node`  (
  ...
  `n_key` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '流程节点名称',
  `type` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '节点类型：start,end,choose,container,base',
  `status` int(0) NULL DEFAULT 0 COMMENT '节点状态：0，正常；-1作废',
  `flow_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '所属流程id',
  `auth_codes` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '需要控制权限编码',
  `create_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人编码',
  `create_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人名称',
  `version` int(0) NULL DEFAULT NULL,
  `ts` timestamp(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '流程控制--流程节点' ROW_FORMAT = Dynamic;
...
CREATE TABLE `flow_node_attr`  (
  ...
  `a_key` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `value` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `flow_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `node_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `version` int(0) NULL DEFAULT NULL,
  `ts` timestamp(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 18 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '流程节点--节点属性' ROW_FORMAT = Dynamic;
...
CREATE TABLE `flow_node_event`  (
  ...
  `flow_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `node_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `e_key` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '事件key',
  `name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '事件名称',
  `order_index` int(0) NULL DEFAULT NULL COMMENT '事件执行顺序',
  ...
  `event_type` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '事件执行类型:js/class/method',
  `content` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '事件内容',
  `create_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `create_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `version` int(0) NULL DEFAULT NULL,
  `ts` timestamp(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '流程节点--节点事件' ROW_FORMAT = Dynamic;
...
CREATE TABLE `flow_node_link`  (
  `id` int(0) NOT NULL AUTO_INCREMENT,
  `l_key` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '链接key',
  `condition_con` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '链接条件',
  `flow_id` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `up_node_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '上级节点id',
  `down_node_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '下级节点id',
  `version` int(0) NULL DEFAULT NULL,
  `ts` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP(0) ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 36 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '流程控制--节点链接' ROW_FORMAT = Dynamic;
...
CREATE TABLE `task_flow`  (
  ...
  `desc_con` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '任务描述',
  `params` json NULL COMMENT '任务参数',
  `create_code` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
INSERT INTO `task_flow` VALUES ('98282931860013066', '测试任务，流程：demo', '98206404485054464', 'demo', 1, '开启', '流程测试', '{\"flag\": \"S\", \"node_id\": \"99121067615846409\", \"node_name\": \"选择事件\", \"node_node_key\": \"select-1\", \"node_node_name\": \"选择1\", \"TASK_RECORD_AUTO\": true, \"TASK_RECORD_LINKS\": \"98211998830952451,98211998830952458\", \"TASK_RECORD_STATUS\": 1, \"TASK_RECORD_UP_NODE\": \"99121067615846408\", \"TASK_RECORD_NODE_TYPE\": \"choose\", \"TASK_RECORD_CONTROLLER\": false}', NULL, NULL, '2021-02-14 14:07:02');
INSERT INTO `task_flow` VALUES ('98282931860013078', '流程任务测试：测试', '1012432328', '测试', 2, '开启任务', '测试流程-demo', '{\"param\": \"2\", \"node_id\": \"99121067615846406\", \"node_name\": \"开始\", \"node_node_key\": \"start-1\", \"node_node_name\": \"开始\", \"TASK_RECORD_NOW\": \"98282931860013067\", \"TASK_RECORD_LINKS\": \"98211998830952458,98211998830952451\", \"TASK_RECORD_STATUS\": 2, \"TASK_RECORD_UP_NODE\": \"99121067615846405\", \"TASK_RECORD_NODE_TYPE\": \"start\"}', NULL, NULL, '2021-02-13 09:20:06');
...
CREATE TABLE `task_flow_node`  (
  ...
  `task_id` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '任务id',
  `flow_id` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '流程id',
  `flow_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '流程名称',
  `node_id` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '节点id',
  `node_key` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `node_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '任务节点名称',
  `content` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '任务节点内容',
  `desc_con` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '任务节点描述',
  `param` json NULL COMMENT '节点额外赋值参数',
  `limit_user` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '任务节点限制人员',
  `create_code` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `create_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `ts` timestamp(0) NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(0),
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '流程任务节点' ROW_FORMAT = Dynamic;
...
INSERT INTO `task_flow_node` VALUES ('99121067615846400', '启动', '98282931860013066', '98206404485054464', 'demo', '98211998830952458', 'select-1', '选择1', 'test_end', '冲动额', '{\"TASK_RECORD_AUTO\": true, \"TASK_RECORD_LINKS\": \"98211998830952451,98211998830952458\", \"TASK_RECORD_STATUS\": 1, \"TASK_RECORD_UP_NODE\": \"98282931860013067\", \"TASK_RECORD_NODE_TYPE\": \"choose\", \"TASK_RECORD_CONTROLLER\": false}', NULL, NULL, NULL, '2021-02-13 09:08:55');
INSERT INTO `task_flow_node` VALUES ('99121067615846401', '开始', '98282931860013066', '98206404485054464', 'demo', '98211998830952451', 'start-1', '开始', NULL, NULL, '{\"TASK_RECORD_NOW\": \"98282931860013067\", \"TASK_RECORD_LINKS\": \"98211998830952458,98211998830952451\", \"TASK_RECORD_STATUS\": 2, \"TASK_RECORD_UP_NODE\": \"99121067615846400\", \"TASK_RECORD_NODE_TYPE\": \"start\"}', NULL, NULL, NULL, '2021-02-13 09:09:40');
INSERT INTO `task_flow_node` VALUES ('99121067615846402', '启动2', '98282931860013066', '98206404485054464', 'demo', '98211998830952458', 'select-1', '选择1', 'test_START', '进入审核', '{\"flag\": \"S\", \"TASK_RECORD_AUTO\": true, \"TASK_RECORD_LINKS\": \"98211998830952451,98211998830952458\", \"TASK_RECORD_STATUS\": 1, \"TASK_RECORD_UP_NODE\": \"99121067615846401\", \"TASK_RECORD_NODE_TYPE\": \"choose\", \"TASK_RECORD_CONTROLLER\": false}', NULL, NULL, NULL, '2021-02-13 09:11:15');
INSERT INTO `task_flow_node` VALUES ('99121067615846403', '事件起始', '98282931860013078', '1012432328', '测试', '98254174117953537', 'evt-start', '事件起始', '开启任务', NULL, '{\"param\": \"2\", \"TASK_RECORD_AUTO\": true, \"TASK_RECORD_LINKS\": \"98226735652274209,98254174117953537\", \"TASK_RECORD_STATUS\": 1, \"TASK_RECORD_UP_NODE\": \"98282931860013082\", \"TASK_RECORD_NODE_TYPE\": \"container_start\", \"TASK_RECORD_CONTROLLER\": false}', NULL, NULL, NULL, '2021-02-13 09:13:43');
INSERT INTO `task_flow_node` VALUES ('99121067615846404', '开始', '98282931860013066', '98206404485054464', 'demo', '98211998830952451', 'start-1', '开始', NULL, NULL, '{\"TASK_RECORD_NOW\": \"99121067615846401\", \"TASK_RECORD_BACK\": \"99121067615846400\", \"TASK_RECORD_LINKS\": \"98211998830952458,98211998830952451\", \"TASK_RECORD_STATUS\": 2, \"TASK_RECORD_UP_NODE\": \"99121067615846402\", \"TASK_RECORD_NODE_TYPE\": \"start\"}', NULL, NULL, NULL, '2021-02-13 09:14:01');
INSERT INTO `task_flow_node` VALUES ('99121067615846405', '启动', '98282931860013066', '98206404485054464', 'demo', '98211998830952458', 'select-1', '选择1', 'test_end', '冲动额', '{\"TASK_RECORD_NOW\": \"99121067615846400\", \"TASK_RECORD_BACK\": \"98282931860013067\", \"TASK_RECORD_LINKS\": \"98211998830952451,98211998830952458\", \"TASK_RECORD_STATUS\": 2, \"TASK_RECORD_UP_NODE\": \"99121067615846404\", \"TASK_RECORD_NODE_TYPE\": \"choose\"}', NULL, NULL, NULL, '2021-02-13 09:19:58');
INSERT INTO `task_flow_node` VALUES ('99121067615846406', '开始', '98282931860013066', '98206404485054464', 'demo', '98211998830952451', 'start-1', '开始', NULL, NULL, '{\"TASK_RECORD_NOW\": \"98282931860013067\", \"TASK_RECORD_LINKS\": \"98211998830952458,98211998830952451\", \"TASK_RECORD_STATUS\": 2, \"TASK_RECORD_UP_NODE\": \"99121067615846405\", \"TASK_RECORD_NODE_TYPE\": \"start\"}', NULL, NULL, NULL, '2021-02-13 09:20:06');
INSERT INTO `task_flow_node` VALUES ('99121067615846407', '选择 bt', '98282931860013066', '98206404485054464', 'demo', '98211998830952458', 'select-1', '选择1', 'test sekect', '选择2', '{\"TASK_RECORD_AUTO\": true, \"TASK_RECORD_LINKS\": \"98211998830952451,98211998830952458\", \"TASK_RECORD_STATUS\": 1, \"TASK_RECORD_UP_NODE\": \"99121067615846406\", \"TASK_RECORD_NODE_TYPE\": \"choose\", \"TASK_RECORD_CONTROLLER\": false}', NULL, NULL, NULL, '2021-02-13 09:26:46');
INSERT INTO `task_flow_node` VALUES ('99121067615846408', '开始', '98282931860013066', '98206404485054464', 'demo', '98211998830952451', 'start-1', '开始', NULL, NULL, '{\"TASK_RECORD_NOW\": \"99121067615846406\", \"TASK_RECORD_BACK\": \"99121067615846405\", \"TASK_RECORD_LINKS\": \"98211998830952458,98211998830952451\", \"TASK_RECORD_STATUS\": 2, \"TASK_RECORD_UP_NODE\": \"99121067615846407\", \"TASK_RECORD_NODE_TYPE\": \"start\"}', NULL, NULL, NULL, '2021-02-14 14:04:00');
INSERT INTO `task_flow_node` VALUES ('99121067615846409', '选择事件', '98282931860013066', '98206404485054464', 'demo', '98211998830952458', 'select-1', '选择1', '测试 选择', '选择2 测试', '{\"TASK_RECORD_AUTO\": true, \"TASK_RECORD_LINKS\": \"98211998830952451,98211998830952458\", \"TASK_RECORD_STATUS\": 1, \"TASK_RECORD_UP_NODE\": \"99121067615846408\", \"TASK_RECORD_NODE_TYPE\": \"choose\", \"TASK_RECORD_CONTROLLER\": false}', NULL, NULL, NULL, '2021-02-14 14:07:02');
...
delimiter ;;
CREATE FUNCTION `flow_container`(`container` varchar(50))
...
delimiter ;;
CREATE FUNCTION `task_has_user`(`usercode` varchar(20),`taskid` varchar(50))
 RETURNS int
  READS SQL DATA 
  SQL SECURITY INVOKER
BEGIN
	...
	SELECT count(1) from(
		SELECT GROUP_CONCAT(user_codes) 
		from (
...
delimiter ;;
CREATE FUNCTION `user_in_tasknode`(`usercode` varchar(20),`tasknodeid` varchar(50))
 RETURNS int
  READS SQL DATA 
  SQL SECURITY INVOKER
BEGIN
	...
	SELECT count(1) from(
		SELECT GROUP_CONCAT(user_codes) user_codes 
		from(
