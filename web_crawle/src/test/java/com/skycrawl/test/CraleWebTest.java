...
* @author hu
*/
public class CraleWebTest extends BreadthCrawler {
	/**
	 ...
	 */
	public CraleWebTest(String crawlPath, boolean autoParse) {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * */
		CraleWebTest crawler = new CraleWebTest("crawl/test", true);
		/**
		 * 启动爬虫，爬取的深度为4层
		 * 添加的第一层种子链接,为第1层
		 */
